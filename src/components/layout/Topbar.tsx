...
import { Search, MapPin, Sun, Menu, LogOut, Sparkles } from 'lucide-react';
      ...
      <div className="flex items-center gap-2 md:gap-3">
        ...
        {isDemoMode && (
          <div className="flex items-center gap-1.5">
            <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-amber-50 text-amber-800 border border-amber-200/80 text-[11px] font-bold shadow-2xs">
            ...
            {onExitDemo && (
              <button
                type="button"
                onClick={onExitDemo}
                className="px-2.5 py-1 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-600 hover:text-slate-900 text-[11px] font-semibold transition-colors cursor-pointer inline-flex items-center gap-1"
