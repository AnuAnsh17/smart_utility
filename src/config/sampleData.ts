...
export const CENTRALIZED_SAMPLE_ANALYSIS: AnalysisResult = {
  bill: {
    id: 'demo-bill-oct-2024',
    fileName: 'sample_electricity_bill.pdf',
    provider: 'Tata Power',
  ...
  forecast: {
    ...
    historicalTrend: [
      ...
      { month: 'Sep', fullMonth: 'Sep 2024', kwh: 334, amount: 2310 },
    ...
    affectingFactors: [
      {
        ...
        description: 'High relative humidity (78%) in Mumbai requires continuous air conditioning compressor cycles.'
      },
      {
        icon: 'cloud-sun',
